...
function NewLotModal({ isOpen, onClose, onCreate }: NewLotModalProps) {
  ...
  const handleCreate = () => {
    if (!canCreate || !selectedSpecies || !selectedVariety) return;
        ...
        <div className="bg-emerald-900 px-5 py-4 text-white">
          <div className="flex items-start justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-3xl font-bold leading-none">Lote</h3>
        ...
        <div className="px-5 py-5 sm:px-6">
          ...
          {step === 2 ? (
            <>
              ...
              <p className="mb-4 text-sm text-slate-600">Elige la especie principal autorizada para este lote.</p>
              ...
              <div className="max-h-[300px] space-y-3 overflow-y-auto pr-1">
                {filteredSpecies.map((sp) => {
                  ...
                  return (
                    ...
                    >
                      <p className="text-2xl font-semibold text-slate-800">{sp.nombre}</p>
          ...
          {step === 3 ? (
            <>
              ...
              <p className="mb-4 text-sm text-slate-600">Elige la variedad específica de la especie seleccionada.</p>

              <div className="mb-4 rounded-xl border border-emerald-200 bg-emerald-50 px-4 py-3">
                <p className="text-sm text-emerald-900">
                  Especie seleccionada:{' '}
                  <span className="font-bold">{selectedSpecies?.nombre ?? 'No seleccionada'}</span>
                </p>
              </div>
                ...
                {availableVarieties.map((variety) => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-full rounded-xl border px-4 py-3 text-left text-xl font-semibold transition ${
                        selected
